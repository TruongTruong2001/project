  ...
  return (
     ...
     <Router>
       ...
       <Switch>
         ...
         <ProtectedRoute isAdmin={true} exact path="/admin/blog" component={CreateBlog} />
         <ProtectedRoute isAdmin={true} exact path="/admin/products" component={AllProducts} />
         <ProtectedRoute isAdmin={true} exact path="/admin/blogs" component={AllBlogs} />
         <ProtectedRoute isAdmin={true} exact path="/admin/qrcodes" component={AllQrcodes} />
