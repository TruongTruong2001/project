...
//Tạo vnpay
exports.createOrderVnpay = catchAsyncErrors(async (req, res, next) => {
  ...
  let tmnCode = "EL8PKGA4";
  let secretKey = "OGWNEXDVCBSQJLXKWMKCPTURBFXAUCOX";
...
exports.vnpay_return = catchAsyncErrors(async (req, res, next) => {
